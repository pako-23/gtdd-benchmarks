...
public class ManageGroupsPage extends SiteAdminPageObject {
	...
	public ManageGroupsPage selectIthGroup(int i) {
		WebElement checkbox = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table/tbody/tr["+i+"]/td[1]/input"));
		new JavascriptExecutor(driver).scrollTo(checkbox);
		checkbox.click();
		return this;
	}
