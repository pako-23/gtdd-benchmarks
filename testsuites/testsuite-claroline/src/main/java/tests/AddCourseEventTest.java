...
public class AddCourseEventTest {
    ...
    public void testClarolineAddCourseEvent() throws Exception {
        ...
        new Select(driver.findElement(By.id("fday"))).selectByIndex(4);
        new Select(driver.findElement(By.id("fmonth"))).selectByIndex(3);
        new Select(driver.findElement(By.id("fyear"))).selectByIndex(4);
        driver.findElement(By.id("location")).clear();
        driver.findElement(By.id("location")).sendKeys("Genoa");
        driver.findElement(By.name("submitEvent")).click();
        WebDriverWait wait = new WebDriverWait(driver, 30);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("courseRightContent")));
